    ...
    <div class="extra-fields-content">
      <div class="extra-field">
        <span class="field-label">
          <?php print $node->content['field_project_title']['field']['#title']; ?>:        
        </span>
        <?php print $field_project_title[0]['view']; ?>
      </div>
      <div class="extra-field acronym">
        <span class="field-label">
          Project acronym: 
        </span>
        <?php print $title; ?>
      ...
      <div class="extra-field participants">
        ...
        <ul>
          <?php 
          foreach ($field_project_participants as $participant) : ?>
            <li>
              <?php print $participant['view']; ?>
            </li>
          <?php endforeach;?>          
        </ul>
      </div>
      <?php endif; ?>
      <?php if ($field_project_url[0]['url'] != NULL): ?>
        <div class="extra-field">
          <span class="field-label">
